...
const initialState = {
  ...
  const mergeRestaurantData = (initial, restaurant) => ({
  ...initial,
  ...Object.fromEntries(
    Object.entries(restaurant)
      ...
      .map(([key, value]) => {
        if (typeof value === 'object' && !Array.isArray(value) && value !== null) {
          return [key, { ...initial[key], ...value }]; // Deep merge objects
        }
...
const EditRestaurant = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  // Rest of the form components will go here
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => handleNestedChange('documents.fssaiLicense', e)}
              className="mt-1 block w-full border border-gray-300 rounded-md p-2"
              />
          </div>
          <div>
